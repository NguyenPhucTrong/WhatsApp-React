...
function CapturePhoto({ hide, setImage }) {
  ...
  return (
    <div className="absolute h-4/6 w-2/6 top-1/4 left-1/3 bg-gray-900 gap-3 round-lg pt-2 flex items-center">
      <div className="flex flex-col gap-4 w-full items-center justify-center">
        ...
        <button
          className="h-16 w-16 bg-white rounded-full cursor-pointer border-8 border-t-teal-light p-2 mb-10"
